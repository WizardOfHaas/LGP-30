...
//Multiply Lower: regs.a = regs.a / mem[track:sector]
export class OrderN implements IOrder{
    name = "n"
    orderNumber = [0, 1, 1, 0] as BitArray
    ...
    multiply(a: BitArray, b: BitArray): BitArray{
        ...
        return packNum(binToDec(resBin.slice(32, 64)))
    }
}